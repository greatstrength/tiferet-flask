...
def build_swagger_ui_html(title: str,
    ...
    '''
    Build the Swagger UI HTML page referencing vendored local assets.

    :param title: The API title shown in the page's <title> tag.
    :type title: str
    :param css_url: The URL serving the vendored swagger-ui.css asset.
    :type css_url: str
    :param bundle_url: The URL serving the vendored swagger-ui-bundle.js asset.
    :type bundle_url: str
    :param openapi_json_url: The URL serving the generated OpenAPI spec.
    :type openapi_json_url: str
    :return: The rendered Swagger UI HTML document.
    :rtype: str
    '''

    # Assemble and return the Swagger UI HTML document.
