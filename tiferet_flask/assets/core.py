'''Flask core assets holding general-purpose service-id and flag constants used by Flask session blueprint handlers when resolving OpenAPI events from DI.'''
